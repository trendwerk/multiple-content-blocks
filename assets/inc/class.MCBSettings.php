...
class MCBSettings {
	...
	function add_settings() {
		...
		add_settings_field('mcb-disable-http-requests',__('Disable HTTP Requests','mcb'),array($this,'show_checkbox'),'mcb-settings','mcb-debug',array('label_for' => 'mcb-disable-http-requests', 'description' => __('Multiple content blocks initializes it\'s blocks through an HTTP request. This way it \'knows\' what blocks you want to use on a certain page. Sometimes these HTTP requests can cause bugs, for example: when they\'re not allowed by the server or the blocks are wrapped in conditional statement like is_user_logged_in(). You can disable them here.','mcb')));
		register_setting('mcb-settings','mcb-disable-http-requests');
		
		add_settings_field('mcb-show-inactive-blocks',__('Show inactive blocks','mcb'),array($this,'show_checkbox'),'mcb-settings','mcb-debug',array('label_for' => 'mcb-show-inactive-blocks', 'description' => __('Sometimes blocks are renamed or in some other way the content is lost. This activates a new meta box on all edit pages with inactive blocks.','mcb')));
	...
	/**
	 * @input'mcb' functions for displaying the different input options
	 */	
